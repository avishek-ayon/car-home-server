...
const uri = `mongodb://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0-shard-00-00.9zavx.mongodb.net:27017,cluster0-shard-00-01.9zavx.mongodb.net:27017,cluster0-shard-00-02.9zavx.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-n175ey-shard-0&authSource=admin&retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const database = client.db("car-home");
...
app.listen(port, () => {
    console.log("car home app listening POrt:", port);
})